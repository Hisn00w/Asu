...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.asu/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.asu/skills/inspect/SKILL.md">\nReferences are relative to /project/.asu/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});

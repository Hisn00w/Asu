 ...
 * - ~/.asu/agent/extensions/sandbox.json (global)
 * - <cwd>/.asu/sandbox.json (project-local)
 *
 * Example .asu/sandbox.json:
 * ```json
 * {
 *   "enabled": true,
 *   "network": {
 ...
 *
 * Setup:
 * 1. Copy sandbox/ directory to ~/.asu/agent/extensions/
 * 2. Run `npm install` in ~/.asu/agent/extensions/sandbox/
 *

...
// ============================================================================
// OAuth API key resolution from ~/.asu/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".asu", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.asu/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.asu/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".asu", "agent");

/**
 * Get an AuthStorage instance backed by ~/.asu/agent/auth.json

...
Sessions are saved automatically to `~/.asu/agent/sessions/`, organized by working directory.
...
- `~/.asu/agent/AGENTS.md` for global instructions
...
- `.asu/SYSTEM.md` for a project
- `~/.asu/agent/SYSTEM.md` globally

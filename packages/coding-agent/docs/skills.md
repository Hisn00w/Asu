...
Discovery rules:
- In `~/.asu/agent/skills/` and `.asu/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.asu/settings.json`:

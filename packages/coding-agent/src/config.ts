...
// The ASu distribution uses this upstream extension point to change the
// executable name, title, config directory, and environment variable prefix
// without renaming the internal workspace packages.
// =============================================================================
...
export const APP_NAME: string = piConfigName || "asu";
export const APP_TITLE: string = "ASu Agent";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".asu";
...
// =============================================================================
// User Config Paths (~/.asu/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.asu/agent/) */

...
/**
 * Migrate sessions from ~/.asu/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.asu/agent/ instead of
 * ~/.asu/agent/sessions/<encoded-cwd>/. This migration moves them

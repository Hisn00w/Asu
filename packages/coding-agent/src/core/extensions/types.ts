...
export interface ExtensionContext {
	...
	/** Gracefully shutdown ASu Agent and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what ASu Agent loaded without re-discovering resources. */
...
export interface ExtensionAPI {
	...
	/** Register a transformer for user and assistant Markdown before ASu Agent renders it in the interactive transcript. */
...
export interface ProviderModelConfig {
	...
	reasoning: boolean;
	/** Maps ASu Agent thinking levels to provider/model-specific values; null marks a level unsupported. */

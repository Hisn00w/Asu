...
// Upstream official distribution detection. These constants must stay identical
// to the upstream Pi project values — they identify the official upstream
// distribution so that forks/rebrands (like this one) are NOT treated as official.
const OFFICIAL_PACKAGE_NAME = "@earendil-works/pi-coding-agent";
const OFFICIAL_APP_NAME = "pi";
const OFFICIAL_CONFIG_DIR_NAME = ".asu";
 ...
 * - this is the official upstream Pi distribution (not a fork/rebrand like ASu Agent)
